...
internal class InitialData
{
    ...
    new List<Customer>
    {
        ...
        Customer.Create(CustomerId.Of(new Guid("79C005AB-2E4E-4F23-9339-D3717A88DE5E")), "jane", "jane@gmail.com"),
        Customer.Create(CustomerId.Of(new Guid("EE4C285F-A98B-4E5A-A0E2-C307D2CC1C0F")), "jack", "jack@gmail.com")
    };
    ...
    public static IEnumerable<Product> Products =>
        new List<Product>
        {
            ...
            Product.Create(ProductId.Of(new Guid("963EF9F1-18B5-49D2-AE2A-5A01A8014A72")), "MacBook Pro X", 1500),
            Product.Create(ProductId.Of(new Guid("68EF6F73-FC81-49C5-950C-D2372509DB75")), "iPad X", 450)
        };
